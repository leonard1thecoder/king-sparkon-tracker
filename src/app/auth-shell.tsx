        ...
        <section className="order-2 lg:order-1">
          ...
          <div className="mt-8 overflow-hidden rounded-[2.25rem] border border-[var(--line)] bg-white/88 p-5 shadow-[var(--shadow-ledger)] backdrop-blur md:p-7">
            ...
            <form className="mt-7 grid gap-5" onSubmit={handleSubmit}>
              ...
              <button type="submit" disabled={isSubmitting} className="inline-flex min-h-11 w-full items-center justify-center gap-2 justify-self-center rounded-full border border-[var(--signal)] bg-[var(--signal)] px-5 py-2 text-sm font-black text-white shadow-[0_12px_28px_rgba(29,92,131,0.18)] transition duration-200 ease-out hover:-translate-y-0.5 hover:border-[var(--gold)] hover:bg-[var(--ink)] disabled:opacity-55 sm:w-auto">
