      ...
      <main className="bg-white text-[var(--ink)]">
        ...
        <section className="relative overflow-hidden border-y border-[var(--line)]">
          ...
          <div className="relative mx-auto max-w-7xl px-5 py-10 md:px-8 md:py-14">
            <p className="inline-flex items-center gap-2 rounded-full border border-[var(--signal)]/20 bg-white px-3 py-1 text-xs font-extrabold uppercase tracking-[0.14em] text-[var(--signal-strong)]"><BookOpen className="h-3.5 w-3.5" /> Knowledge base</p>
            <h1 className="mt-4 max-w-3xl text-4xl font-black tracking-[-0.05em] md:text-5xl">Guides written for the real workflow, not SEO filler.</h1>
            <p className="mt-4 max-w-2xl text-base leading-7 text-[var(--steel)]">Each guide solves one operational problem, shows the exact role and screen, includes troubleshooting, and links to the related feature or job. No duplicated filler, no invented stats.</p>
          </div>
        </section>
