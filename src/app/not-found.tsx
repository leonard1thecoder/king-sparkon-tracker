  ...
  return (
    <main className="min-h-screen bg-white px-6 py-8 text-[var(--ink)]">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-4xl flex-col items-center justify-center text-center">
        <Link href="/" aria-label="King Sparkon home" className="mb-10 inline-flex transition-all duration-200">
          <Image src="/king-sparkon-logo.svg" alt="King Sparkon logo" width={136} height={60} className="h-14 w-auto object-contain" />
        </Link>
