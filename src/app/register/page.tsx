  ...
  return (
    <InteractiveRegisterShell
      ...
      fields={[
        ...
        { name: "cellphoneNumber", label: "Cellphone number", type: "tel", placeholder: "Example: +27821234567", autoComplete: "tel", visibleForPrivileges: ["USER", "BUSINESS_OWNER", "AFFILIATE"], helper: "Required. Use international format for WhatsApp and account contact." },
