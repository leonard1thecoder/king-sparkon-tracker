...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${siteUrl}/articles/barcode-inventory-guide`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${siteUrl}/articles/qr-ticket-operations`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${siteUrl}/articles/worker-tips-payouts`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${siteUrl}/articles/affiliate-referrals`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
