          ...
          <div className="relative overflow-hidden bg-[var(--ink)] px-5 py-5 text-white">
            ...
            <div className="relative flex items-start justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="relative grid h-12 w-12 shrink-0 place-items-center rounded-2xl border border-white/[0.14] bg-white/10 shadow-[var(--shadow-soft)]">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs font-semibold text-white/[0.58]">Barcode, tickets, dashboards, Dev Hub</p>
                </div>
              </div>
              ...
              <button
                ...
                className="grid h-10 w-10 shrink-0 place-items-center rounded-full border border-white/12 bg-white/[0.08] text-white/70 hover:bg-white/[0.14] hover:text-white"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
