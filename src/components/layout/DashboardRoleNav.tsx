...
const navByRole: Record<UserRole, NavItem[]> = {
  ...
  Owner: [
    ...
    { label: "Business Reports", href: "/dashboard/owner/reports", icon: BarChart3, description: "Stock and product movement" },
    { label: "Plan & Billing", href: "/dashboard/owner/billing", icon: CreditCard, description: "Subscription and feature access" },
