  ...
  return (
    <>
      ...
      <main className="grid gap-5 p-5 md:p-8">
        <Card>
          <CardHeader><CardTitle>Backend wiring</CardTitle></CardHeader>
          <CardContent className="grid gap-4">
            ...
            <p className="text-sm leading-6 text-[var(--steel)]">This page is separated from the dashboard shell and must use the domain API module for live data. Empty states are intentional until backend data returns.</p>
          </CardContent>
        </Card>
        {children}
      </main>
