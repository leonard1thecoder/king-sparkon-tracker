...
export function FounderVerificationCard() {
  return (
    <div className="mt-5 max-w-2xl text-center">
      ...
      <img src={badgeUrl} alt="King Sparkon badge" className="mx-auto mt-4 h-28 w-auto drop-shadow-[0_22px_34px_rgba(88,28,135,0.22)] sm:h-32" />

      <Link href="#verify-sizolwakhe-mthimunye" className="mx-auto mt-3 inline-flex min-h-10 items-center justify-center gap-2 rounded-full border border-[var(--gold)] bg-gradient-to-r from-[var(--gold)] via-orange-400 to-purple-500 px-4 text-xs font-black uppercase tracking-[0.12em] text-[var(--ink)] shadow-[var(--shadow-soft)] hover:border-[var(--ink)]">
