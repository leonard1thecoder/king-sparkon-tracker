                ...
                <tr key={event.id}>
                  ...
                  <td>
                    <div className="flex flex-wrap gap-2">
                      <Link href={`/tickets/events/${event.id}`} className="inline-flex min-h-10 items-center justify-center gap-2 rounded-full border border-[var(--line)] bg-white px-3 text-xs font-black text-[var(--steel)] hover:border-[var(--signal)] hover:text-[var(--ink)]">
